        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <ul class="navbar-nav ml-auto">
                <li class="nav-item active" style="margin-left: 10px">
                    <a class="nav-link" href="index.php">CODER <span class="sr-only">(current)</span></a>
                </li>
                <li class="nav-item active" style="margin-left: 10px">
                    <a class="nav-link" href="user/login.php">LOGIN <span class="sr-only">(current)</span></a>
                </li>
                <li class="nav-item active" style="margin-left: 10px">
                    <a class="nav-link" href="user/register.php">SIGN UP <span class="sr-only">(current)</span></a>
                </li>
            </ul>
