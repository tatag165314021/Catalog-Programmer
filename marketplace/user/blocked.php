            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="container" align=Center>
                        <br/>
                        <h1 style="font-size:20px;"><i class="fa fa-ban" aria-hidden="true"></i>ANDA TELAH DI BLOKIR OLEH ADMIN<i class="fa fa-ban" aria-hidden="true"></i></h1>
                        <p>Jika Ingin Melepas Blokir<br>
